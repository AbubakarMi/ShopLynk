    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50/40 via-white to-accent-50/30 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          {/* Form */}
          <motion.form onSubmit={handleSubmit} variants={stagger} className="space-y-6">
            {/* Email / Phone */}
            <motion.div variants={fadeIn}>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-4 border-2 border-border rounded-xl text-textDark placeholder-textLight focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white/50"
            ...
            <motion.div variants={fadeIn}>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-12 py-4 border-2 border-border rounded-xl text-textDark placeholder-textLight focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white/50"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            <motion.div variants={fadeIn} className="flex items-center justify-between">
              <label className="flex items-center space-x-2 cursor-pointer group">
                <input
                  ...
                  className="w-5 h-5 border-2 border-border rounded-md text-primary focus:ring-2 focus:ring-primary/20 transition-all cursor-pointer"
                />
                <span className="text-sm font-semibold text-textLight group-hover:text-textDark transition-colors">
                  Remember me
                </span>
              </label>
              <Link
            ...
            <motion.div variants={fadeIn} className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center space-x-2 px-4 py-3 border-2 border-border rounded-xl hover:border-primary hover:bg-primary-50/50 transition-all duration-300 group"
              >
          ...
          {/* Trust Indicators */}
          <motion.div variants={fadeIn} className="mt-8 flex items-center justify-center space-x-6 text-xs text-textLight">
